...
$status = [
    ...
    'admin_ok' => false,
    'admin_count' => 0,
    'installer_remote_allowed' => defined('INSTALLER_ALLOW_REMOTE') ? (bool)INSTALLER_ALLOW_REMOTE : false,
    'is_local_request' => isLocalRequest(),
    'recovery_available' => isLocalRequest() && defined('ADMIN_RECOVERY_ENABLED') && ADMIN_RECOVERY_ENABLED && defined('ADMIN_RECOVERY_KEY') && trim((string)ADMIN_RECOVERY_KEY) !== '',
    'missing_tables' => []
];
