...
function buildOrderCredentialView(order) {
  ...
  return `<div class="vps-info" style="margin-top:14px">
    ...
    <div class="vps-copy-all"><button class="btn btn-outline" style="width:100%;padding:8px;font-size:12px" data-ip="${escapeHtml(ip)}" data-port="${escapeHtml(port)}" data-user="${escapeHtml(user)}" data-pass="${escapeHtml(pass)}" onclick="copyAllVpsFromData(this)"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:-2px;margin-right:2px"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg> 复制全部信息</button></div>
  </div>`;
}
